# ptx
# Autogenerated from man page /usr/local/share/man/man1/ptx.1
...
complete -c ptx -l version -d 'output version information and exit AUTHOR Written by Francois Pinard'
