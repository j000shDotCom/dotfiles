# ssh-add
# Autogenerated from man page /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/share/man/man1/ssh-add.1
...
complete -c ssh-add -s K -d 'When adding identities, each passphrase will also be stored in the user\'s key…'
complete -c ssh-add -s A -d 'Add identities to the agent using any passphrase stored in the user\'s keychain'
