# ssh-keygen
# Autogenerated from man page /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/share/man/man1/ssh-keygen.1
...
complete -c ssh-keygen -s G -d 'Generate candidate primes for DH-GEX'
...
complete -c ssh-keygen -s J -d 'Exit after screening the specified number of lines while performing DH candid…'
complete -c ssh-keygen -s j -d 'Start screening at the specified line number while performing DH candidate sc…'
complete -c ssh-keygen -s K -d 'Write the last line processed to the file checkpt while performing DH candida…'
...
complete -c ssh-keygen -s M -d 'Specify the amount of memory to use (in megabytes) when generating candidate …'
...
complete -c ssh-keygen -s O -d 'Specify a certificate option when signing a key'
...
complete -c ssh-keygen -s S -d 'Specify start point (in hex) when generating candidate moduli for DH-GEX'
complete -c ssh-keygen -s s -d 'Certify (sign) a public key using the specified CA key'
complete -c ssh-keygen -s T -d 'Test DH group exchange candidate primes (generated using the G option) for sa…'
...
complete -c ssh-keygen -s W -d 'Specify desired generator when testing candidate moduli for DH-GEX'
complete -c ssh-keygen -s y -d 'This option will read a private OpenSSH format file and print an OpenSSH publ…'
complete -c ssh-keygen -s Y -d 'Cryptographically sign a file or some data using a SSH key'
