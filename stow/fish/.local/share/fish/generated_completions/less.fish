# less
# Autogenerated from man page /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/share/man/man1/less.1.gz
...
complete -c less -s U -l UNDERLINE-SPECIAL -d 'Causes backspaces, tabs and carriage returns to be treated as control charact…'
...
complete -c less -l window -d 'Changes the default scrolling window size to n lines'
