# clang
# Autogenerated from man page /Library/Developer/CommandLineTools/usr/share/man/man1/clang.1
...
complete -c clang -o flax-vector-conversions -d 'Allow loose type checking rules for implicit vector conversions'
