# ssh
# Autogenerated from man page /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/share/man/man1/ssh.1
...
complete -c ssh -s A -d 'Enables forwarding of the authentication agent connection'
