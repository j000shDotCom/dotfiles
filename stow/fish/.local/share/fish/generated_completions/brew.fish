...
complete -c brew -l github -d 'Open the GitHub source page for formula in a browser'
...
complete -c brew -l env -d 'If std is passed, use the standard build environment instead of superenv'
...
complete -c brew -l display-times -d 'Print install times for each formula at the end of the run'
...
complete -c brew -s l -d 'List formulae in long format'
complete -c brew -s r -d 'Reverse the order of the formulae sort to list the oldest entries first'
complete -c brew -s t -d 'Sort formulae by time modified, listing most recently modified first'
...
complete -c brew -l greedy -d 'Print outdated casks with auto_updates or version :latest'
...
complete -c brew -l macports -d 'Search for text in the given package manager\'s list'
complete -c brew -l fink -d 'Search for text in the given package manager\'s list'
complete -c brew -l opensuse -d 'Search for text in the given package manager\'s list'
complete -c brew -l fedora -d 'Search for text in the given package manager\'s list'
complete -c brew -l debian -d 'Search for text in the given package manager\'s list'
complete -c brew -l ubuntu -d 'Search for text in the given package manager\'s list'
complete -c brew -l full -d 'Convert a shallow clone to a full clone without untapping'
complete -c brew -l shallow -d 'Fetch tap as a shallow clone rather than a full clone'
...
complete -c brew -l shell -d 'Summarise Homebrew\'s build environment as a plain list'
...
complete -c brew -l commit -d 'When passed with --write, generate a new commit after writing changes to the …'
...
complete -c brew -l macos -d 'Version of macOS the bottle should be built for'
complete -c brew -l workflow -d 'Dispatch specified workflow (default: dispatch-build-bottle. yml)'
complete -c brew -l upload -d 'Upload built bottles to Bintray'
...
complete -c brew -l bintray-org -d 'Upload to the specified Bintray organisation (default: homebrew)'
complete -c brew -l bintray-repo -d 'Upload to the specified Bintray repository (default: mirror)'
complete -c brew -l no-publish -d 'Upload to Bintray, but don\'t publish'
...
complete -c brew -l no-upload -d 'Download the bottles and apply the bottle commit, but don\'t upload to Bintray…'
...
complete -c brew -l archive-item -d 'Upload to the specified Internet Archive item (default: homebrew)'
complete -c brew -l bintray-mirror -d 'Use the specified Bintray repository to automatically mirror stable URLs defi…'
...
complete -c brew -l branch -d 'Initialize Git repository and setup GitHub Actions workflows with the specifi…'
...
complete -c brew -l ci-upload -d 'Use the Homebrew CI bottle upload options'
