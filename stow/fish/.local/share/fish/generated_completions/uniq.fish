# uniq
# Autogenerated from man page /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/share/man/man1/uniq.1
complete -c uniq -s c -d 'Precede each output line with the count of the number of times the line occur…'
complete -c uniq -s d -d 'Only output lines that are repeated in the input'
