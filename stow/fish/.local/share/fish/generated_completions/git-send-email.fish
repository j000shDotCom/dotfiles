# git-send-email
# Autogenerated from man page /Library/Developer/CommandLineTools/usr/share/man/man1/git-send-email.1
...
complete -c git-send-email -l signed-off-by-cc -d 'If this is set, add emails found in Signed-off-by: or Cc: lines to the cc list'
