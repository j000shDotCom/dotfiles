# h2load
# Autogenerated from man page /usr/local/share/man/man1/h2load.1
...
complete -c h2load -s w -l window-bits -d 'Sets the stream level initial window size to (2**<N>)-1. sp Default: 30'
...
complete -c h2load -l ciphers -d 'Set allowed  cipher list'
