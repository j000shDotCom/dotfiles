# lex
# Autogenerated from man page /Library/Developer/CommandLineTools/usr/share/man/man1/lex.1
...
complete -c lex -s v -l verbose -d 'write summary of scanner statistics to stdout . SS "Files:"'
...
complete -c lex -l yylineno -d 'track line count in yylineno . SS "Generated code:"'
...
complete -c lex -l noFUNCTION -d 'do not generate a particular FUNCTION . SS "Miscellaneous:"'
complete -c lex -s c -d 'do-nothing POSIX option'
complete -c lex -s n -d 'do-nothing POSIX option . HP -?'
