# ssh-agent
# Autogenerated from man page /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/share/man/man1/ssh-agent.1
...
complete -c ssh-agent -s P -d 'Specify a pattern-list of acceptable paths for PKCS#11 shared libraries that …'
